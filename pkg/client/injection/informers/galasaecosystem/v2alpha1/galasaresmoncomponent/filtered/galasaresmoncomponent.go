...
func Get(ctx context.Context, selector string) v2alpha1.GalasaResmonComponentInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/galasa-dev/kubernetes-operator/pkg/client/informers/externalversions/galasaecosystem/v2alpha1.GalasaResmonComponentInformer with selector %s from context.", selector)
	}
