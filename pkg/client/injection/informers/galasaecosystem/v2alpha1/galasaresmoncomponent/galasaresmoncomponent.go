...
func Get(ctx context.Context) v2alpha1.GalasaResmonComponentInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/galasa-dev/kubernetes-operator/pkg/client/informers/externalversions/galasaecosystem/v2alpha1.GalasaResmonComponentInformer from context.")
	}
